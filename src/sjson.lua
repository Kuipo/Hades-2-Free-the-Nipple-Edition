...
sjson.hook(gui_portraits_vfx_path, function(data)
    for index, animation_data in ipairs(data.Animations) do
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Chaos_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Nemesis_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Nemesis_Averted_01"
        -- end

        -- if animation_data.Name == "Portrait_Nemesis_Bath_01"
        -- or animation_data.Name == "Portrait_Nemesis_Bath_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Nemesis_Bath_01"
        -- end

        -- -- Selene
        -- if animation_data.Name == "Portrait_Selene_Default_01"
        -- or animation_data.Name == "Portrait_Selene_Default_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Selene_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Athena_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Demeter_Pleased_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Hec_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Hec_Bath_01"
        -- end
        ...
        -- --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Hec_Baby_01"
        -- -- end

        -- -- Eris
        -- if animation_data.Name == "Portrait_Eris_Default_01"
        -- or animation_data.Name == "Portrait_Eris_Default_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Eris_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Eris_FiredUp_01"
        -- end

        -- if animation_data.Name == "Portrait_Eris_Unsure_01"
        -- or animation_data.Name == "Portrait_Eris_Unsure_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Eris_Unsure_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Apollo_Default_01"
        -- end

        -- if animation_data.Name == "Portrait_Apollo_Displeased_01"
        -- or animation_data.Name == "Portrait_Apollo_Displeased_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Apollo_Displeased_01"
        -- end

        -- if animation_data.Name == "Portrait_Apollo_Serious_01"
        -- or animation_data.Name == "Portrait_Apollo_Serious_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Apollo_Serious_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Hephaestus_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Charon_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Skelly_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Dionysus_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Cyclops_Default_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Ares_Default_01"
        -- end

        -- Need images first
        -- if animation_data.Name == "Portrait_Ares_Displeased_01"
        -- or animation_data.Name == "Portrait_Ares_Displeased_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Ares_Displeased_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Prometheus_Default_01"
        -- end

        -- Need images first
        -- if animation_data.Name == "Portrait_Prometheus_Defeated_01"
        -- or animation_data.Name == "Portrait_Prometheus_Defeated_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Prometheus_Defeated_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Persephone_Queen_Calculating_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Persephone_Queen_Apprehensive_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_Persephone_Queen_FiredUp_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_ZagPresent_Empathetic_01"
        -- end

        -- if animation_data.Name == "Portrait_ZagPresent_Defiant_01"
        -- or animation_data.Name == "Portrait_ZagPresent_Defiant_01_Exit" then
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_ZagPresent_Defiant_01"
        -- end
        ...
        --     animation_data.FilePath = "Kuipo-FreeTheNippleEdition\\Portrait_ZagPresent_Defiant_01_NoEnter"
        -- end
